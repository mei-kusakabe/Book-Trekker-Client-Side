...
const Advertisement = () => {
    ...
    return (
        <div className='sg m-5 py-5'>
            ...
            {
                product?.length ? <h3 className='fw-bold fs-2 py-3' style={{ textDecoration: 'none', color: "#EB6440", textDecorationColor: "#EB6440" }} >Top Advertisement..</h3> : <h3 className='d-none'>none</h3>
            }
            <div className='ad-all  border-0'>

                {
                    product?.length ?
                        <>
                            {
                                product.map(c => <div className='ad mx-5 teal-c text-center border-1 p-0  shadow'
                                    key={c._id}>
                                    <img src={c?.pic} alt="" />
